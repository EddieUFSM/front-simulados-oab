...
function createData(id, name, de, para, data) {
    return { id, name, de, para, data };
}
...
const headCells = [
    ...
    { id: 'de', numeric: true, disablePadding: false, label: 'de' },
    { id: 'para', numeric: true, disablePadding: false, label: 'para' },
...
export default function EnhancedTable() {
    ...
    const [orderBy, setOrderBy] = React.useState('de');
